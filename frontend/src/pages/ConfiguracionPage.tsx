  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-[#80756A] text-sm mt-1">Ajustes del sistema</p>
      </div>
      <div className="bg-[#231710] border border-[#2A1B13] rounded-2xl flex flex-col items-center justify-center py-24 px-8 text-center">
        <div className="w-16 h-16 rounded-2xl bg-[#2A1B13] border border-[#3a2a1e] flex items-center justify-center mb-5">
          <svg viewBox="0 0 24 24" fill="none" stroke="#80756A" strokeWidth="1.5" className="w-8 h-8">
        ...
        <h2 className="text-[#FFF8ED] font-semibold text-lg mb-2">Configuración</h2>
        <p className="text-[#80756A] text-sm">Próximamente disponible.</p>
      </div>
    </div>
  );
}
